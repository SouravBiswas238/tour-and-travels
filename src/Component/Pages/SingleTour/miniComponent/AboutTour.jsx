...
import tourImg from '../../../../asset/Img/bora.jpg'
import { RxCross2 } from 'react-icons/rx'
import { FcApproval } from 'react-icons/fc'
const AboutTour = () => {
    return (
        <div>
            <div className="pt-12 dark:bg-gray-800 dark:text-gray-100 
            ...
            ">
                ...
                w-full  xl:col-span-3 italic">
                    <div className='text-start  leading-8 '>
                        <p className=" text-2xl font-semibold sm:text-xl text-primary">Explore Tours</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit veniam, et temporibus explicabo nihil at accusantium est magni deleniti cumque repudiandae aut odio incidunt quod omnis enim magnam architecto ratione consequatur sunt.</p>
                    </div>
                    <div className='flex'>
                        {/* about tour */}
                        <div className='text-start  leading-7 pr-2'>
                            <p className="inline-block text-2xl font-semibold sm:text-xl text-primary pt-3">Advance Facilities</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua..</p>
                            <p className="inline-block text-2xl font-semibold sm:text-xl text-primary pt-3">Challenge</p>
                            <p className='pt-3'> Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore quasi architecto beatae vitae dicta..</p>

                        </div>

                        <img src={tourImg} alt="" className="opacity-100 w-1/2 float-right text-end h-60 sm:h-96" />
                    </div>
                    <div>
                        <h1 className='text-start text-xl font-semibold text-primary'>Included/Exclude</h1>
            ...
            <div className="w-3/4 flex flex-col justify-center pb-5 ">
                ...
                <div className="space-y-4">
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ring-violet-400">Day 1st</summary>
                    ...
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ring-violet-400">Day 3rd</summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">Lectus iaculis orci metus vitae ligula dictum per. Nisl per nullam taciti at adipiscing est. </p>
                    </details>
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:ring-violet-400">Day 2nd</summary>
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">Lectus iaculis orci metus vitae ligula dictum per. Nisl per nullam taciti at adipiscing est. </p>
                    </details>
